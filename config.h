...
static char *fonts[]          = { "SourceCodePro-Regular:size=14","JoyPixels:pixelsize=13:antialias=true:autohint=true", "Font Awesome 6 Brands:pixelsize=15:antialias=true:autohint=true", "Font Awesome 6 Free:pixelsize=15:antialias=true:autohint=true" };
...
static const Rule rules[] = {
	...
	*/
	...
	{ "Evernote", 			NULL,	   NULL,   1 << 6,	  		0,	       	0,	  		0,	   -1 },
...
/*	{ ShiftMask,			XK_Print,	spawn,		SHCMD("miampick") }, */
	...
	{ MODKEY,	XK_Escape,	spawn,		SHCMD("pauseallmpv; slock") },
